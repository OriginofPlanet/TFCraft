...
public class TEBarrel extends NetworkTileEntity implements IInventory
{
	...
	public static void registerRecipes()
	{
		...
		TFCBlocks.sands.getAllBlocks().forEach(b -> BarrelManager.getInstance().addRecipe(new BarrelRecipe(new ItemStack(b, 1, 32767), new FluidStack(TFCFluids.LIMEWATER, 100), new ItemStack(TFCItems.mortar, 16), new FluidStack(TFCFluids.LIMEWATER, 100)).setMinTechLevel(0)));
